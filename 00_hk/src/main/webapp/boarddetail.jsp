	...
	<tr>
		<td colspan="2">
			...
			<input type="button" value="글목록" 
						onclick="location.href='userController.jsp?command=boardlist'"/>
		</td>
	</tr>
</table>
<script type="text/javascript">
	...
	function updateForm(seq){
		...
		location.href="userController.jsp?command=boardupdateform&seq="+seq;
	}
	// boardDelete.jsp
	function delBoard(seq){
		location.href="userController.jsp?command=boarddelete&seq="+seq;
	}
</script>
</body>
</html>