...
<script type="text/javascript">
	function insertBoardForm(){
		location.href=
	        "userController.jsp?command=insertboardform";
	}
...
<form action="userController.jsp" method="get">아이디: 
	...
	<%
		for(HkDto dto:list){
			...
			<tr>
				...
				<td><%=dto.getTseq()%></td>
				<td><%=dto.getTid()%></td>
				<td><a href="userController.jsp?command=boarddetail&seq=<%=dto.getTseq()%>"><%=dto.getTtitle()%></a></td>
